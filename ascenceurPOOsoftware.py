...
class Ascenseur:
    ...
    def getPositionUtilisateur():
        positionUtilisateur=self.entree2
    ...
    def getNombreEtage(self):
        ...
        print(self.etages)
        values={}
        for i in range(self.nombreEtage):
            value ='étage'+str(i)
            values[value]=i
        print(values)
    ...
    def ouvrirPorte(self):
        ...
        print("3 secondes pour l'ouverture de porte")
        self.porteOuverte = True
        time.sleep(2)  # attendre 3 secoundes pour l'ouverture de la porte de l'acsenseur

    def fermerPorte(self):
        """"" méthode qui ouvre automatiquement la porte de l'ascenseur"""

        print("3 secondes pour la fermeture de porte")
        self.porteOuverte = False
        time.sleep(2)  # attendre 3 sencondes pour la fermeture de la porte de l'acsenseur
...
def on_release(key):
    """Fonction qui met l'ascenseur à l'arrêt en cas d'urgence"""
...
"""Création d'un objet ascenseur avec son initialisation"""
